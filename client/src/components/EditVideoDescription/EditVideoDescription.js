...
import './EditVideoDescription.css';

const EditVideoDescription = ({ curDescription }) => {
	// MODAL TOGGLE
	...
	return (
		<>
			<Button
				className="EditVideoDesc-Btn p-2 w-50 btn-sm bskr-btn-purple"
				variant="primary"
				onClick={handleShow}
			>
